...
while {STOP_burning_vehicle_car} do {
    ...
    _vehicle = entities [_arry_type_vehilce, [], false, true];
        { 
            if(_x getHitPointDamage "hitEngine" >= 0.91 and !(_x in vehicle_on_fire)) then{
                ...
                [_x,_time_to_burn_osnova,_damage_crew,_kill_crew] spawn {
                        ...
                        [_vehicle_select],
                        {
                            ...
                            _vehicle_action_id = [
                                ...
                                {   
                                    ...
                                    [(_this select 0), (_this select 2)] remoteExecCall ["BIS_fnc_holdActionRemove",0];
                    ...
                    // delete action
                    _vehicle_action_id = _vehicle_select getVariable "vehicleActionId";
                    [_vehicle_select, _vehicle_action_id] remoteExecCall ["BIS_fnc_holdActionRemove", 0];
                }
            }
        } forEach _vehicle;
    sleep 15;
